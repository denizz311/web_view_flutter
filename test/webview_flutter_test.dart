...
void main() {
  ...
  final _fakeCookieManager = _FakeCookieManager();
  ...
  testWidgets('Create WebView', (tester) async {
  ...
  testWidgets('Javascript mode', (tester) async {
    await tester.pumpWidget(const WebView(
      initialUrl: 'https://youtube.com',
  ...
  testWidgets('Invalid urls', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        onWebViewCreated: (webViewController) {
  ...
  testWidgets('Headers in loadUrl', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        onWebViewCreated: (webViewController) {
  ...
  testWidgets("Can't go back before loading a page", (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        onWebViewCreated: (webViewController) {
  ...
  testWidgets("Can't go back with no history", (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
  ...
  testWidgets('Can go back', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://flutter.io',
  ...
  testWidgets("Can't go forward before loading a page", (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        onWebViewCreated: (webViewController) {
  ...
  testWidgets("Can't go forward with no history", (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://flutter.io',
  ...
  testWidgets('Can go forward', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://flutter.io',
  ...
  testWidgets('Go forward', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://youtube.com',
  ...
  testWidgets('Current URL', (tester) async {
    WebViewController? controller;
    await tester.pumpWidget(
      WebView(
        onWebViewCreated: (webViewController) {
  ...
  testWidgets('Reload url', (tester) async {
    late WebViewController controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://flutter.io',
  ...
  testWidgets('evaluate Javascript', (tester) async {
    late WebViewController controller;
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://flutter.io',
  ...
  testWidgets('Cookies can be cleared once', (tester) async {
    await tester.pumpWidget(
      const WebView(
        initialUrl: 'https://flutter.io',
      ),
  ...
  testWidgets('Second cookie clear does not have cookies', (tester) async {
    await tester.pumpWidget(
      const WebView(
        initialUrl: 'https://flutter.io',
      ),
  ...
  testWidgets('Initial JavaScript channels', (tester) async {
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://youtube.com',
        javascriptChannels: <JavascriptChannel>{
          JavascriptChannel(name: 'Tts', onMessageReceived: (msg) {}),
          JavascriptChannel(name: 'Alarm', onMessageReceived: (msg) {}),
        },
      ),
    );
  ...
  testWidgets('Unique JavaScript channel names are required', (tester) async {
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://youtube.com',
        javascriptChannels: <JavascriptChannel>{
  ...
  testWidgets('JavaScript channels update', (tester) async {
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://youtube.com',
        javascriptChannels: <JavascriptChannel>{
    ...
    await tester.pumpWidget(
      WebView(
        ...
        javascriptChannels: <JavascriptChannel>{
          JavascriptChannel(name: 'Tts', onMessageReceived: (msg) {}),
          JavascriptChannel(name: 'Alarm2', onMessageReceived: (msg) {}),
          JavascriptChannel(name: 'Alarm3', onMessageReceived: (msg) {}),
        },
      ),
    );
  ...
  testWidgets('Remove all JavaScript channels and then add', (tester) async {
    await tester.pumpWidget(
      WebView(
        initialUrl: 'https://youtube.com',
        javascriptChannels: <JavascriptChannel>{
  ...
  testWidgets('JavaScript channel messages', (tester) async {
  ...
  group('$PageStartedCallback', () {
    testWidgets('onPageStarted is not null', (tester) async {
      String? returnedUrl;
    ...
    testWidgets('onPageStarted is null', (tester) async {
      await tester.pumpWidget(const WebView(
        initialUrl: 'https://youtube.com',
      ));
    ...
    testWidgets('onPageStarted changed', (tester) async {
      String? returnedUrl;
  ...
  group('$PageFinishedCallback', () {
    testWidgets('onPageFinished is not null', (tester) async {
      String? returnedUrl;
    ...
    testWidgets('onPageFinished is null', (tester) async {
      await tester.pumpWidget(const WebView(
        initialUrl: 'https://youtube.com',
      ));
    ...
    testWidgets('onPageFinished changed', (tester) async {
      String? returnedUrl;
  ...
  group('$PageLoadingCallback', () {
    testWidgets('onLoadingProgress is not null', (tester) async {
      int? loadingProgress;
    ...
    testWidgets('onLoadingProgress is null', (tester) async {
      await tester.pumpWidget(const WebView(
        initialUrl: 'https://youtube.com',
      ));
    ...
    testWidgets('onLoadingProgress changed', (tester) async {
      int? loadingProgress;
  ...
  group('navigationDelegate', () {
    testWidgets('hasNavigationDelegate', (tester) async {
      await tester.pumpWidget(const WebView(
        initialUrl: 'https://youtube.com',
      ));
      ...
      await tester.pumpWidget(WebView(
        initialUrl: 'https://youtube.com',
        navigationDelegate: (r) => NavigationDecision.navigate,
      ));

      expect(platformWebView.hasNavigationDelegate, true);
    });

    testWidgets('Block navigation', (tester) async {
  ...
  group('debuggingEnabled', () {
    testWidgets('enable debugging', (tester) async {
      await tester.pumpWidget(const WebView(
  ...
  testWidgets('Set UserAgent', (tester) async {
    await tester.pumpWidget(const WebView(
      initialUrl: 'https://youtube.com',
      javascriptMode: JavascriptMode.unrestricted,
    ));
...
class FakePlatformWebView {
  ...
  Future<dynamic> onMethodCall(MethodCall call) {
    switch (call.method) {
      ...
      case 'addJavascriptChannels':
        final channelNames = List<String>.from(call.arguments);
  ...
  void fakeJavascriptPostMessage(String jsChannel, String message) {
    ...
    _ambiguate(ServicesBinding.instance)!
        ...
        .handlePlatformMessage(channel.name, data, (data) {});
  }
